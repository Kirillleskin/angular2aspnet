...
AppModule = __decorate([
    core_1.NgModule({
        ...
        declarations: [app_component_1.AppComponent, home_component_1.HomeComponent, book_component_1.BookComponent],
        providers: [{ provide: common_1.APP_BASE_HREF, useValue: '/' }, book_service_1.BookService],
